...
/**
 * Functional interface for {@link TdiPlatformShape}. Any class extending
 * {@link TdiPlatformShape} MUST HAVE a constructor with the exact argument type list
 * as this interface.
 */
@FunctionalInterface
public interface TdiPlatformShapeFactory {
